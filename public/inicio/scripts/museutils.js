...
(function (c) {
    ...
    Muse.Utils.getCssVendorPrefix = function () {
        if (!Muse.Utils.isDefined(Muse.Utils.getCssVendorPrefix.flag))
            Muse.Utils.getCssVendorPrefix.flag = /webkit/i.test(
    ...
    Muse.Utils.allStyleSheetRulesFromOneSheet = function (a, b) {
        ...
        for (
            ...
            if (m(p)) {
                if (
                    ((p = Muse.Utils.allStyleSheetRulesFromOneSheet(p, b)),
                    null != p)
                )
        ...
        c ||
            (document.defaultView
                ? (c = document.defaultView
                      ...
                      .getPropertyValue(b))
                : a.currentStyle &&
                  (c = a.currentStyle[Muse.Utils.toCamelCase(b)]));
        ...
        return {
            dir:
                ...
                (c >= 315 && c < 360)
                    ...
                    : "horizontal",
            reverse:
                b === "horizontal" ? c >= 135 && c <= 315 : c >= 45 && c <= 225,
        };
    };
    Muse.Utils.updateSlideshow_fstpOffsetSize = function (a) {
        var b = c(window),
            ...
            i = a.$clip
                ? a.$clip
                : a._findWidgetElements("." + g.clipClassName);
        ...
        if (!g || g == "_self") {
            ...
            if (l && g > i) {
                ...
                var g = j.offset(),
                    ...
                    n = Math.min(
                        l,
                        g.top + (a && !a.isStandard() ? a.scrollTop() : 0)
                    ),
                    p = Math.min(
                        i,
                        g.left + (a && !a.isStandard() ? a.scrollLeft() : 0)
                    ),
                ...
                if (o) {
                    ...
                    n = r
                        ...
                        : Math.min(
                              n,
                              c(j).parents(".AccordionWidget").offset().top
                          );
                    p = g
                        ? d
                        : Math.min(
                              p,
                              c(j).parents(".AccordionWidget").offset().left
                          );
                }
                d = function () {
                    m.scrollTo(p, n);
        ...
        var b = function () {
            ...
            if (b.length !== 0) {
                var f = b.offset(),
                    ...
                    j = Math.min(
                        j,
                        f.top + (l && !l.isStandard() ? l.scrollTop() : 0)
                    ),
                    f = Math.min(
                        d,
                        f.left + (l && !l.isStandard() ? l.scrollLeft() : 0)
                    );
                b.scrollTo(f, j);
            }
        };
    ...
    Muse.Utils.addHyperlinkAnchor = function (a) {
        ...
        a.bind("mousedown", function (a) {
            (Muse.Utils.isMouseLeftClick(a) ||
                Muse.Utils.isMouseMiddleClick(a)) &&
                d.push(this);
        });
    ...
    Muse.Utils.saveHyperlinkInfo = function (a, b, d, g, i) {
        ...
        if (
            ...
            !(m && m != "_self") &&
            !(0 <= k.indexOf("/")) &&
            (n.charAt(n.length - 1) == "/" && (n += "index.html"),
                ...
                c.ajax({
                    ...
                    complete: function () {
                        if (Muse.Utils.isDefined(window.PIE)) {
                            ...
                            for (
                                var a = 0;
                                a < Muse.Utils.pieFunctionQueue.length;
                                ++a
                            )
            ...
            Muse.Utils.needPIE(function () {
                ...
                if (!b.data("mu-ie-matrix")) {
                    ...
                    if (
                        !d ||
                        !(
                            d.toLowerCase().indexOf("opacity") > 0 &&
                            d.indexOf("=100") < 0
                        )
                    ) {
                        if (
                            a.childNodes.length &&
                            !Muse.Browser.Features.checkCSSFeature(
                                "border-radius"
                            ) &&
                    ...
                    d.watch("height", function () {
                        ...
                        "fixed" != b.css("position") &&
                            ...
                            b
                                .closest(a)
                                .height(
                                    c(b.closest(a).children()[0]).outerHeight()
                                );
                    }));
            };
        ...
        Muse.Browser.Features.checkCSSFeature("transform") ||
            c("*[data-mu-ie-matrix]").each(function () {
                ...
                a.hasClass("actAsDiv")
                    ...
                    ? a.wrap(
                          '<span class="actAsInlineDiv rotateWrapper"></span>'
                      )
    ...
    Muse.Utils.resetPageWidth = function () {
        var a = c("#page");
        a !== void 0 &&
            (a.css("width", ""), c(window).trigger("pageWidthChanged"));
    };
    Muse.Utils.getMinWidthOfElem = function (a) {
        var b = parseFloat(a.css("min-width") ? a.css("min-width") : 0);
        b === 0 &&
            (b = parseFloat(
                a.attr("data-min-width") ? a.attr("data-min-width") : 0
            ));
        return b;
    };
    Muse.Utils.dropInOneBucketOfSizeAndPinPolicy = function (a, b, d, g) {
        if (a !== void 0 && b !== void 0) {
            ...
            else if (b === "fluidWidth" || b === "fluidWidthHeight")
                i = d.responsive;
                    ...
                    if (Muse.Utils.isInPixel(j)) g += parseFloat(j);
                        ...
                        Muse.Utils.moveElementsOutsideViewport(h),
                            ...
                            Muse.Utils.isInPixel(j) &&
                                j !==
                                    Muse.Utils
                                        .marginLeftForMovingElementsOutSideViewPort &&
                                (g += parseFloat(j)),
            ...
            switch (b) {
                ...
                case "page_fixedRight":
                    a.forEach(function (a) {
                        var b = Muse.Utils.getChildWidth(a, d, !1),
                            ...
                            f = -1,
                            i = Muse.Utils.getLeftAdjustmentAmountDoneByParents(
                                a,
                                g
                            );
                        i >= 0 && (c -= i);
                        c > 0 &&
                            (f = Muse.Utils.isElementFixedSize(a) ? c : c + b);
                ...
                case "page_fixedCenter":
                    a.forEach(function (a) {
                        ...
                        o > 0 &&
                            ((q =
                                Muse.Utils.getLeftAdjustmentAmountDoneByParents(
                                    a,
                                    g
                                )),
                            (q = q < 0 ? 0 : q),
    ...
    Muse.Utils.isMenuWidget = function (a) {
        return (
            a.is("nav") &&
            (a.hasClass("MenuBar") || a.hasClass("MenuBarVertical"))
        );
    };
    ...
    Muse.Utils.computeMinWidthForWidgetChilds = function (a, b) {
        ...
        a.forEach(function (a) {
            ...
            if (
                ...
                (b = (b = window.getComputedStyle(a[0]).width)
                    ? parseFloat(b)
                    : 0),
                ...
                a.hasClass("SlideShowWidget") || a.hasClass("PamphletWidget")
                    ? (c =
                          WebPro.Widget.ContentSlideShow.prototype
                              .defaultPlugins[0])
                    : a.hasClass("TabbedPanelsWidget")
                    ? (c =
                          WebPro.Widget.TabbedPanels.prototype
                              .defaultPlugins[0])
                    : a.hasClass("AccordionWidget") &&
                ...
                c &&
                    c._setMinWidth &&
                    (c._setMinWidth(a, !0),
                    (b = Muse.Utils.getMinWidthOfElem(a)));
            }
    ...
    Muse.Utils.getMinWidthForElement = function (a, b) {
        ...
        if ((a && a.length > 0 && a[0].style.minWidth === "") || b) {
            ...
            i.push(
                Muse.Utils.computeMinWidthForChildsWithMinWidth(
                    d.ChildWithMinWidth,
                    a
                )
            );
            i.push(
                Muse.Utils.computeMinWidthForWidgetChilds(d.ChildWidgets, a)
            );
    ...
    (function (a) {
        ...
        d.prototype.init = function (d) {
            ...
            if (0 != this.$verticalSpacer.length) {
                this.enabled = !0;
                var g = Muse.Utils.getCSSIntValue(
                    this.$verticalSpacer,
                    "min-height"
                );
        ...
        d.prototype.doUpdate = function () {
            if (this.enabled && 0 != this.$verticalSpacer.length) {
                var d = Math.round(
                        this.contentAboveSpacer -
                            this.$verticalSpacer.offset().top
                    ),
                    g =
                        this.$verticalSpacer.offset().top +
                            this.contentBelowSpacer <
    ...
    Muse.Utils.animationFrameFx = (function (a) {
        ...
        var c,
            ...
            i = function () {
                c &&
                    (Muse.Utils.requestAnimationFrame(i),
                    b.tick(),
                    d.doUpdate());
            };
        b.timer = function (b) {
